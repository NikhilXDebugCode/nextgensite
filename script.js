...
const SEARCH_INDEX = [
  ...
  { title: 'Careers',                     url: 'careers.html',    icon: 'CR',  desc: 'Web Dev (5), Java Dev (2), MERN (4), AI Engineer, ML Engineer, Internship.' },
  { title: 'Java Developer',              url: 'careers.html',    icon: 'JV',  desc: 'Java Developer — Spring Boot, J2EE. 2 openings available.' },
  { title: 'Python Developer',            url: 'careers.html',    icon: 'PY',  desc: 'Python Developer — Django, FastAPI, Flask. Full-time remote.' },
  { title: 'MERN Stack Developer',        url: 'careers.html',    icon: 'MN',  desc: 'MERN Stack Developer — MongoDB, Express, React, Node. 4 openings.' },
  { title: 'Full Stack Developer',        url: 'careers.html',    icon: 'FS',  desc: 'Full Stack Developer — React, Node.js, PostgreSQL. Hybrid.' },
  { title: 'ML Engineer',                 url: 'careers.html',    icon: 'ML',  desc: 'ML Engineer — TensorFlow, PyTorch, MLOps. Remote.' },
  { title: 'Internship Program',          url: 'careers.html',    icon: 'IN',  desc: 'Internships for B.Tech, BCA, MCA, M.Tech, B.Sc. CS/IT students.' },
